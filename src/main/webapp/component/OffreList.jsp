                    ...
                    <div class="job-box d-md-flex align-items-center justify-content-between mb-30">
                        <div class="job-left my-4 d-md-flex align-items-center flex-wrap">
                            ...
                            <div class="job-content">
                                <h5 name="title" class="text-center text-md-left">Front End Developer</h5>
                                <ul class="d-md-flex flex-wrap text-capitalize ff-open-sans">
                                    <li class="me-2 d-block w-100">
                                        <p  name="description" style="font-weight: normal ;">As A frond developer u will </p>
                                    </li>


                                        <li class="mr-md-4 ">
                                           <span style="color: black ; font-weight: bold"> Date De Publication : </span>12/20/2025
                                        </li>
                                </ul>
                            </div>
                        </div>
